...
Current release: **1.5.3 - Item Entry Polish**
...
2. If you change cached files, update `APP_VERSION` in `app.js` and keep `CACHE_NAME` in `sw.js` synchronized, for example `fit-roulette-v1.5.3`.
3. Commit and push.
...
node codex-tools/verify-fit-roulette-v1.5.3-app.js
node codex-tools/verify-fit-roulette-v1.5.3-static.js
node codex-tools/verify-fit-roulette-v1.5.3-layout.js
node codex-tools/verify-fit-roulette-v1.5.3-ui.js
node codex-tools/verify-fit-roulette-deploy.js
```

The rendered v1.5.3 layout and UI verifiers require Playwright and an installed Chrome, Edge, or Chromium browser; set `FIT_ROULETTE_BROWSER` when the browser executable is not in a standard location.
